...
public class LandlordAddProperty extends AppCompatActivity {
    ...
    private Spinner propertyTypeSpinner, provinceSpinner, citySpinner;
    ...
    private void addPropertyToFirestore() {
        ...
        String barangay = barangayEditText.getText().toString().trim(); // Get Barangay input
        ...
        propertyData.put("price", formattedPrice);  // Save formatted price
        propertyData.put("type", propertyType);
        propertyData.put("province", propertyProvince);
        propertyData.put("city", propertyCity);  // Add comma after City
        propertyData.put("barangay", barangay + ",");  // Add comma after Barangay
        propertyData.put("address", address + ",");    // Add comma after Address
        ...
        if (interiorImageUri != null) {
            ...
            uploadCounter[0]++; // Increment counter
        }
        ...
        // Save the property to Firestore when both images are uploaded
