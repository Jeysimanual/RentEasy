    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_SELECT_IMAGE && resultCode == Activity.RESULT_OK && data != null) {
            ...
            if (selectedImageUri != null) {
                uploadImageToFirebase(selectedImageUri); // Upload and set image
            }
        }
    }
                ...
                storageRef.getDownloadUrl().addOnSuccessListener(uri -> {
                    ...
                    db.collection("Tenants").document(userId)
                            ...
                            .addOnSuccessListener(aVoid -> {
                                ...
                                Toast.makeText(TenantProfile.this, "Profile picture updated", Toast.LENGTH_SHORT).show();
                            })
                            .addOnFailureListener(e -> Toast.makeText(TenantProfile.this, "Failed to save image URL", Toast.LENGTH_SHORT).show());
                });
